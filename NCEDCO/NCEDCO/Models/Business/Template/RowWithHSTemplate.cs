...
namespace NCEDCO.Models.Business.Template
{
    ...
    {
        public RowWithHSTemplate(string Certificateid ,M_Cerificate MCertificate, string LOGOpath, string DocPath, string AuthOffer, string SignDate)
        {
        ...
        public RowWithHSTemplate(M_Cerificate MCertificate, string LOGOpath, string DocPath)
        {
            this.LOGOimgPath = LOGOpath;
            this.Model = MCertificate;
            this.CertificateSavePath = DocPath;
        ...
        protected override bool drawCertificateOfOrginHeader()
        {
            try
            {
                ...
                PdfPCell PortOFLoadCellData = new PdfPCell(new Phrase(this.Model.CountyOfOrigin, fontBoxDetailFontSmal));//----------this.CertificateHead.LoadingPort1
                PortOFLoadCellLbl.FixedHeight = 20f;
                PortOFLoadCellLbl.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
        ...
        protected override void printlistRow()
        {
            ...
            PdfPCell GoodItemHead = new PdfPCell(new Phrase(Model.Goods_Item.Replace("<br />", "\r\n"), fontItemDetails));
            ...
            PdfPCell SummaryHead = new PdfPCell(new Phrase(Model.HSCode.Replace("<br />", "\r\n"), fontItemDetails));
            ...
            PdfPCell ShipMarkHead = new PdfPCell(new Phrase(Model.QtyNUnit.Replace("<br />", "\r\n"), fontItemDetails));
