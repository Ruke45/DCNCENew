...
namespace NCEDCO.Models.Business.Template
{
    ...
    {
        public ColumnWithoutHSTemplate(M_Cerificate MCertificate, string LOGOpath, string DocPath, string AuthOffer, string Date)
        {
        ...
        public ColumnWithoutHSTemplate(string CertificateID,M_Cerificate MCertificate, string LOGOpath, string DocPath, string AuthOffer, string Telephone)
        {
            this.LOGOimgPath = LOGOpath;
            this.Model = MCertificate;
            this.CertificateSavePath = DocPath;
