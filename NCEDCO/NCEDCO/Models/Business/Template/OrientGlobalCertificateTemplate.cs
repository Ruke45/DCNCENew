...
{
    public class OrientGlobalCertificateTemplate : Base_Certificate
    {
        public OrientGlobalCertificateTemplate(M_Cerificate MCertificate, string LOGOpath, string DocPath, string AuthOffer, string Date)
        {
            this.LOGOimgPath = LOGOpath;
            this.Model = MCertificate;
            this.CertificateSavePath = DocPath;
            this.CertificateId = MCertificate.RefferencNo;
            this.AuthoirzedOfficer = AuthOffer;
            this.SignedDate = Date;
        }

        public OrientGlobalCertificateTemplate(string CertificateID,M_Cerificate MCertificate, string LOGOpath, string DocPath, string AuthOffer, string Telephone)
        {
            this.LOGOimgPath = LOGOpath;
            this.Model = MCertificate;
            this.CertificateSavePath = DocPath;
        ...
        protected override bool drawCertificateOfOrginHeader()
        {
            try
            {
                ...
                Phrase consignorNamePhrase = new Phrase(this.Model.Consignor_Exporter.Replace("<br />", "\r\n") + "\n", fontBoxDetail); //-------this.CertificateHead.Consignor1
                ...
                Phrase consigneeNamePhrase = new Phrase(this.Model.Consignee.Replace("<br />", "\r\n") + "\n", fontBoxDetail);//--------this.CertificateHead.Consignee1
                ...
                // Consignee Name Start 
                PdfPCell InoviceNoNDateCell = new PdfPCell(new Phrase("4. Invoice No : " + this.Model.InvoiceNo, fontItemDetails));
                ...
                PdfPCell InoviceNoNDateCell1 = new PdfPCell(new Phrase("5. Invoice Date : " + this.Model.InvoiceDate, fontItemDetails));
                InoviceNoNDateCell1.Border = Rectangle.NO_BORDER;
                InoviceNoNDateCell1.Border = Rectangle.TOP_BORDER;
                ...
                PdfPCell countryOfOriginHeaderCell = new PdfPCell(new Phrase("6. Country of Origin", fontBoxHeader));
                ...
                PdfPCell cntryOfOriginDetailCell = new PdfPCell(new Phrase(this.Model.CountyOfOrigin, fontBoxDetail));//---------
                ...
                string PortFloading = "7. Port Of Loading";
                string Vessel = "8. Vessel ";
                ...
                PdfPCell PortOFLoadCellData = new PdfPCell(new Phrase(this.Model.PortOfLoading, fontBoxDetailFontSmal));//----------this.CertificateHead.LoadingPort1
                PortOFLoadCellLbl.FixedHeight = 20f;
                PortOFLoadCellLbl.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                ...
                PdfPCell VessleCellData = new PdfPCell(new Phrase(this.Model.Vessel, fontBoxDetailFontSmal));//------this.CertificateHead.Vessel1
                ...
                string PortOfDischarg = "9. Port of Discharge";
                string PlaceFDelivery = "10. Place of Delivery";
                ...
                PdfPCell PortDischgCellData = new PdfPCell(new Phrase(this.Model.PortOfDischarge, fontBoxDetailFontSmal)); //this.CertificateHead.PortOfDischarge1
                ...
                PdfPCell PlaceofDeliveryCellData = new PdfPCell(new Phrase(this.Model.PlaceOfDelivery, fontBoxDetailFontSmal)); //this.CertificateHead.PortOfDischarge1
        ...
        protected override void drawBottom(string Comment)
        {
            ...
            PdfPCell totInvoL = new PdfPCell(new Phrase("17. Total Invoice Value", fontBoxHeader));
            ...
            PdfPCell totInvoD = new PdfPCell(new Phrase(this.Model.TotalInvoiceValue.ToString(), fontBoxDetail));//---------this.CertificateHead.TotalInvoiceValue1.ToString()
            ...
            PdfPCell totQuantL = new PdfPCell(new Phrase("18. Total Quantity", fontBoxHeader));
            ...
            PdfPCell totQuntyD = new PdfPCell(new Phrase(this.Model.TotalQuantity, fontBoxDetail)); //this.CertificateHead.TotalQuantity1
            ...
            PdfPCell SubNameData = new PdfPCell(new Phrase(Model.ClientContact_Name + "-" + Model.ClientContact_Designation, fontFooterDetails)); //CertificateHead.CustomerName1
            ...
            PdfPCell SubContactData = new PdfPCell(new Phrase(Model.ClientContact_Telephone, fontFooterDetails));//CertificateHead.Customer_Telephone
            ...
            PdfPCell SubDateData = new PdfPCell(new Phrase(Model.RequestDate.ToString("dd/MM/yyyy"), fontFooterDetails));//CertificateHead.RequestDate1.ToString("dd/MM/yyyy")
        ...
        protected override void printListHead()
        {
            ...
            PdfPCell HSHead = new PdfPCell(new Phrase("15. HS Code", fontTableHeader));
            HSHead.FixedHeight = 20f;
            HSHead.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
            CertItemTbl.AddCell(HSHead);

            PdfPCell QttHead = new PdfPCell(new Phrase("16. Qty & Units", fontTableHeader));
        ...
        protected override void printlistRow()
        {
            ...
            //{
                ...
                PdfPCell SummaryHead = new PdfPCell(new Phrase(Model.SummaryDescription, fontFooterDetails));//CertReqDetails[i].SummaryDesc1
                SummaryHead.Colspan = 2;
                SummaryHead.FixedHeight = 170f;
        ...
        private void drwRectangle()
        {
            ...
            PdfPCell GoodItemHead = new PdfPCell(new Phrase(this.Model.Remarks, fontBoxDetail));//Rectangle
            GoodItemHead.Colspan = 7;
            GoodItemHead.FixedHeight = 60f;
            GoodItemHead.HorizontalAlignment = PdfPCell.ALIGN_JUSTIFIED;
        ...
        public override bool CreateCertificate(string Comment)
        {
            try
            {
