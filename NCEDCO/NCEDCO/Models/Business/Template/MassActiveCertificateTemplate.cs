...
{
    public class MassActiveCertificateTemplate :Base_Certificate
    {
        public MassActiveCertificateTemplate(M_Cerificate MCertificate, string LOGOpath, string DocPath, string AuthOffer, string Date)
        {
        ...
        public MassActiveCertificateTemplate(string CertificateID,M_Cerificate MCertificate, string LOGOpath, string DocPath, string AuthOffer, string Telephone)
        {
            this.LOGOimgPath = LOGOpath;
            this.Model = MCertificate;
            this.CertificateSavePath = DocPath;
        ...
        protected override bool drawCertificateOfOrginHeader()
        {
            try
            {
                ...
                PdfPCell InoviceNoNDateCell1 = new PdfPCell(new Phrase("& Invoice Date : " + this.Model.InvoiceDate, fontItemDetails));
                ...
                PdfPCell countryOfOriginHeaderCell = new PdfPCell(new Phrase("5. Country of Origin", fontBoxHeader));
                ...
                PdfPCell cntryOfOriginDetailCell = new PdfPCell(new Phrase(this.Model.CountyOfOrigin, fontBoxDetail));//---------this.CertificateHead.CountryName1
                ...
                string PortFloading = "6. Port Of Loading";
                string Vessel = "7. Vessel ";
                ...
                PdfPCell PortDischgCellData = new PdfPCell(new Phrase(this.Model.OtherComments ,fontBoxDetailFontSmal)); //this.CertificateHead.PortOfDischarge1
        ...
        protected override void drawBottom(string Comment)
        {
            ...
            PdfPCell totInvoL = new PdfPCell(new Phrase("14. Total Invoice Value", fontBoxHeader));
            ...
            PdfPCell totInvoD = new PdfPCell(new Phrase(this.Model.TotalInvoiceValue, fontBoxDetail));//---------this.CertificateHead.TotalInvoiceValue1.ToString()
            ...
            PdfPCell totQuantL = new PdfPCell(new Phrase("15. Total Quantity", fontBoxHeader));
            ...
            PdfPCell SubNameData = new PdfPCell(new Phrase(this.Model.ClientContact_Name + "-" + this.Model.ClientContact_Designation, fontFooterDetails)); //CertificateHead.CustomerName1
            ...
            PdfPCell SubContactData = new PdfPCell(new Phrase(this.Model.ClientContact_Telephone, fontFooterDetails));//CertificateHead.Customer_Telephone
            ...
            PdfPCell SubDateData = new PdfPCell(new Phrase(this.Model.RequestDate.ToString("dd/MM/yyyy"), fontFooterDetails));//CertificateHead.RequestDate1.ToString("dd/MM/yyyy")
        ...
        protected override void printListHead()
        {
            ...
            PdfPCell ShipMarkHead = new PdfPCell(new Phrase("10. Shipping Mark", fontTableHeader));
            ShipMarkHead.FixedHeight = 20f;
            ShipMarkHead.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
            CertItemTbl.AddCell(ShipMarkHead);

            PdfPCell PackageHead = new PdfPCell(new Phrase("11. Package Typ/Qty", fontTableHeader));
            PackageHead.FixedHeight = 20f;
            PackageHead.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
            CertItemTbl.AddCell(PackageHead);

            PdfPCell SummaryHead = new PdfPCell(new Phrase("12. Summary Description", fontTableHeader));
            ...
            PdfPCell QttHead = new PdfPCell(new Phrase("13. Qty & Units", fontTableHeader));
